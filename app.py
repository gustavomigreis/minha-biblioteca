...
# --- NOVAS FUNÇÕES DE EDIÇÃO/EXCLUSÃO PARA DATASETS EXTERNOS ---
...
if check_password():
    opcoes_menu.extend([
        ...
        "Gestão de Dados Externos", # NOVO ITEM
        "Cadastro Manual",
...
# === PÁGINA 3: GESTÃO DE DADOS EXTERNOS (NOVA) ===
...
# === PÁGINA 4: CADASTRO MANUAL (Inserir Novo Item - BIBLIOGRAFIA) ===
...
# === PÁGINA 5: CADASTRO DE DADOS EXTERNOS (Inserir Novo Item - DATASETS) ===
